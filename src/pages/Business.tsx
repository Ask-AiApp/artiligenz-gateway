...
const Business = () => {
  ...
  useEffect(() => {
    const fetchBusiness = async () => {
      try {
        setLoading(true);
        const { data, error } = await supabase.functions.invoke('fetch-rss?category=business');
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-sky-950">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <CategoryHero
          icon={Briefcase}
          title="Business (AI in Industry)"
          subtitle="AI developments in business and enterprise"
        />
